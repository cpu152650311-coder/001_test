...
const tasks = [
  ...
  { ref: 'cruzr.png', out: 'home/cruzr.png',
    prompt: 'Use this product as reference. Clean professional product photo of CRUZR humanoid service robot. Pure white background, front view, square 1:1 crop, studio lighting, isolated on white, no shadows. Keep original design: slim humanoid upper body on wheeled base, large chest touchscreen display, white and blue color scheme, UBTECH branding.' },
  ...
  { ref: 'CC201.jpg', out: 'products/cleinbot-cc201/hero-robot.png',
    prompt: 'Use this product as reference. Professional product photo of CLEINBOT CC201 outdoor sweeping robot. Pure white background, front view, square 1:1 crop, studio lighting, no shadows, high detail. Keep original design: white body, black accents, UBTECH branding, dustbin container on top.' },
  ...
  { ref: 'cruzr.png', out: 'products/cruzr/hero-robot.png',
    prompt: 'Use this product as reference. Professional product photo of CRUZR humanoid service robot. Pure white background, front view, portrait vertical orientation, studio lighting, no shadows, high detail. Keep original design: humanoid torso on wheeled base, large chest touchscreen, white-blue color scheme, UBTECH branding.' },
