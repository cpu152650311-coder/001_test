        ...
        <div className="container mx-auto px-6 py-28 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={openModal} className="inline-flex items-center justify-center bg-white text-brand px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/90 hover:shadow-2xl hover:-translate-y-0.5 transition-all">
            ...
            {solutions.map((s) => (
              <div key={s.title} className="bg-white rounded-2xl overflow-hidden border border-line card-hover flex flex-col">
                ...
                <div className="p-7 flex flex-col flex-1">
                  ...
                  <button onClick={openModal} className="w-full bg-brand text-white py-3 rounded-xl font-semibold hover:bg-brand-hover transition-colors text-sm">
                    Get Quote →
                  </button>
                </div>
              </div>
