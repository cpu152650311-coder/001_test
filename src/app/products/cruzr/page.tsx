          ...
          <div className="max-w-5xl mx-auto hero-gradient rounded-3xl overflow-hidden shadow-2xl">
            <div className="grid md:grid-cols-[1.65fr_1fr] gap-0 md:items-stretch">
              ...
              <div className="p-10 text-white flex flex-col justify-center">
                ...
                <button onClick={openModal} className="bg-white text-brand px-8 py-3.5 rounded-xl font-bold hover:shadow-2xl hover:-translate-y-0.5 transition-all w-fit">
                  Get Your Demo →
                </button>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-surface-subtle rounded-xl border border-line overflow-hidden">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full flex items-center justify-between p-5 text-left hover:bg-brand-light/30 transition">
                  <span className="font-bold text-ink pr-4 text-sm">{faq.q}</span>
                  <svg className={`w-5 h-5 text-brand flex-shrink-0 transition-transform ${openFaq === i ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center mt-10">
            <button onClick={openModal} className="hero-gradient text-white px-10 py-4 rounded-xl font-bold hover:shadow-xl hover:-translate-y-0.5 transition-all">
              ...
              <div key={r.name} className="bg-white rounded-2xl overflow-hidden border border-line card-hover flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button onClick={openModal} className="flex-1 bg-brand text-white py-2.5 rounded-lg font-semibold text-sm hover:bg-brand-hover transition">Inquire</button>
                  </div>
                </div>
              </div>
            ))}
