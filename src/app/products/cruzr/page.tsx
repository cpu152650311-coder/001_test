  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#F8FAFB]">
      <div className="text-center space-y-4 p-8">
        ...
        <h1 className="text-4xl font-black text-gray-800">CRUZR</h1>
        <p className="text-gray-500 max-w-md mx-auto">Humanoid Service Robot — Product page under construction.</p>
